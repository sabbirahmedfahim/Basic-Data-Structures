...
void insert_at_head(Node *&head, int val) //added '&', do not need pos, know this is 0. 
{
    // Node *newNode = new Node; //notice: frequently doing the same mistake
    Node *newNode = new Node(val);
    newNode->next = head;
    head = newNode;
...
int main()
{
    ...
    while (1)
    {
        ...
        {
            // int pos; //we alreadly know the position of head
            int v;
